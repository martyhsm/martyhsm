...
abstract class StateMachine {
    ...
    protected constructor(queueCapacity?: number, topState?: State, topStartState?: string) {
        ...
        if (topState) {
            ...
            if (topState.parentState) 
                throw "A top state cannot have a parent state.";
        ...
        if (topStartState) {
            topStartState = _.lowerCase(_.trim(topStartState
                ? topStartState
                : ''));
    ...
    protected registerStates(...states : Array < State >) : void {
        ...
        _.forEach(states, state => {
            if (!state) 
                throw "A state cannot be null or undefined";
    ...
    public reset() : void {
        ...
        if (this._isResetting) 
            throw "This state machine is already resetting.";
